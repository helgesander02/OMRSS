...
func (OC *OMACO_Memorizer) M_Store_Data(fileName string, testcase int) {
	...
	StoreCSV("OSACO1000ms.csv", OC.average_objs_osaco[4], testcase)
	StoreCSV("OSACO800ms.csv", OC.average_objs_osaco[3], testcase)
	StoreCSV("OSACO600ms.csv", OC.average_objs_osaco[2], testcase)
	StoreCSV("OSACO400ms.csv", OC.average_objs_osaco[1], testcase)
	StoreCSV("OSACO200ms.csv", OC.average_objs_osaco[0], testcase)
	log.Printf("Storing OSACO_IAS data to CSV...\n")
	StoreCSV("OSACO_IAS1000ms.csv", OC.average_objs_osaco_ias[4], testcase)
	StoreCSV("OSACO_IAS800ms.csv", OC.average_objs_osaco_ias[3], testcase)
	StoreCSV("OSACO_IAS600ms.csv", OC.average_objs_osaco_ias[2], testcase)
	StoreCSV("OSACO_IAS400ms.csv", OC.average_objs_osaco_ias[1], testcase)
	StoreCSV("OSACO_IAS200ms.csv", OC.average_objs_osaco_ias[0], testcase)
